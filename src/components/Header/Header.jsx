...
export function Header() {
    ...
    return <header className="header w-full max-w-full sticky top-0 z-100">
            ...
            <div className="relative" ref={dropdownRef}>
                ...
                {open && (
                    <div className="absolute right-0 top-[calc(100%+8px)] w-[200px] bg-white rounded-[4px] shadow-[0px_0px_6px_0px_#00000021] border border-[#DBDFEA] z-40 overflow-hidden">
                        ...
                        <div>
                            <button className="w-full flex items-center gap-[12px] px-[20px] py-[18.11px] hover:bg-[#fff5f5] duration-[.2s]">
        ...
        {createPortal(
            <div id='change-password-modal-wrap' className={`w-full max-w-full h-full fixed top-0 flex justify-center items-center z-100 bg-[#00000066] ${!openModal ? 'opacity-0 invisible' : 'opacity-100 visible'}`} onClick={(e) => {
